"""Build the Space Grunts PortMaster host and BYO-data ZIP without proprietary game data."""
import argparse
import hashlib
import os
...
SHA256 = 'bf9ffdd25dd9ea58f29247bf7a48c0be6ccec513344c9623eb6ce2c506074016'
...
def main():
    ...
    if args.package_only:
        if not (ROOT/'package/spacegrunts/runtime/spacegrunts-host.jar').is_file():
    ...
    runtime = ROOT/'package/spacegrunts/runtime'
    runtime.mkdir(parents=True, exist_ok=True)
    with zipfile.ZipFile(runtime/'spacegrunts-host.jar', 'w') as out:
        # Only adaptation classes ship. Compile declarations and libraries never do.
        for path in sorted((classes/'org/portmaster/spacegrunts').rglob('*.class')):
