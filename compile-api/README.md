...
Only org/portmaster/spacegrunts classes are written to spacegrunts-host.jar. All
com/orangepixel declarations and open-source dependencies are excluded. The player
supplies the unchanged supported spacegrunts.jar for the real runtime implementation.
